-- Migration 022: Multi-user data isolation and Better Auth tables

-- Add user_id column to existing domain tables
ALTER TABLE routine_tasks ADD COLUMN user_id TEXT;
...
ALTER TABLE workout_sessions ADD COLUMN user_id TEXT;
ALTER TABLE finance_accounts ADD COLUMN user_id TEXT;
ALTER TABLE finance_transactions ADD COLUMN user_id TEXT;
ALTER TABLE news_articles ADD COLUMN user_id TEXT;
ALTER TABLE rss_feeds ADD COLUMN user_id TEXT;
ALTER TABLE skill_areas ADD COLUMN user_id TEXT;
ALTER TABLE learning_logs ADD COLUMN user_id TEXT;
