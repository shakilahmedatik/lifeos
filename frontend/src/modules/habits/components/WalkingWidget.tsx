          ...
          {showCustomInput && (
            <form onSubmit={handleCustomSubmit} className="flex gap-2 w-full animate-fade-in pt-1">
              <input
                ...
                className="flex-1 bg-gray-950 border border-gray-700 rounded-lg px-3 py-1 text-xs text-gray-100 placeholder-gray-500 focus:outline-none focus:border-orange-500"
              />
              <Button
                size="sm"
                type="submit"
