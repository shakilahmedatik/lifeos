        ...
        <Card className="bg-linear-to-br from-purple-900/30 to-gray-800/80 border-purple-500/20">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-[11px] text-secondary mt-1">{hoursCompleted}h completed total</p>
            </div>
              ...
              {stats.weeklyTrends.map((day) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold text-primary">{dayLabel}</span>
                  </div>
                );
              })}
            </div>

            <div className="mt-4 pt-3 border-t border-border flex items-center justify-between text-xs text-secondary">
